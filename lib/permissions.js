...
var checkUXRolePermissions = function (user, roles) {
...
module.exports.checkUXRolePermissions = checkUXRolePermissions;

var _permissionChecks = {
    create:     function (user, obj) {  return checkUXRolePermissions(user, ['admin']); },
    read:       function (user, obj) {  return checkUXRolePermissions(user, ['admin']); },
    list:       function (user, obj) {  return checkUXRolePermissions(user, ['admin']); },
    update:     function (user, obj) {  return checkUXRolePermissions(user, ['admin']); }
}
